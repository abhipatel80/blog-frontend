          ...
          <div className="shadow-md md:w-[24rem] w-[18rem] px-10 rounded-md py-7 bg-white">
            <div className="inputs">
              {user?.image?.startsWith("https") ? (
                ...
                <img
                  src="/default-profile-img.jpg"
                  alt="userProfile"
                  className="rounded-full w-[8rem] h-[8rem] m-auto"
                />
              )}
            </div>
            <div className="inputs">
            ...
            {disable ? (
              <button
                type="submit"
                onClick={update}
                className="bg-purple-600 hover:bg-purple-700 text-white px-5 py-1.5 rounded-md cursor-pointer mt-4"
              >
                Update
              </button>
            ) : (
